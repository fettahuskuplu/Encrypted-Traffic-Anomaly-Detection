...
def train_and_evaluate_lstm():
    ...
    # =========================================================================
    # YENİ EKLENEN BÖLÜM: SINIF AĞIRLIKLANDIRMA (CLASS WEIGHTING)
    # =========================================================================
    ...
    sinif_agirliklari_tensor = torch.FloatTensor(sinif_agirliklari).to(device)
    print(f"    - Sınıf Ağırlıkları (Ceza Çarpanları): {sinif_agirliklari}")

    # Kayıp fonksiyonu artık bu ceza çarpanlarını dikkate alacak
